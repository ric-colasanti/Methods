class Node{
    ...
    diffuse(){
        ...
        if(this._resource[Cell.tNext]>0.1){
            this.biomass+=0.0051;
            this._resource[Cell.tNext]-=0.0051;
        }
...
class Cell {
    ...
    getAllResource(){
        ...
        return this._resource[Cell.tNow]+this.occupant._resource[Cell.tNow]+this.occupant.biomass;
    }
    setResource(value){
        this._resource[Cell.tNow]=value;
    }
...
class Grid{
    constructor(size) {
        ...
        for(let x = 0;x<this.size;x++){
            this.cells[this.pos(x,2)].setResource(100)
        }
